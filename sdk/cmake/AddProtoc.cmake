function(ADD_PROTOC NAME PROTO_SRC_ROOT_FOLDER PROTO_BUILD_PATH PROTOBUF_DIR_SUFFIX)
    if(NOT Protobuf_SRC_ROOT_FOLDER)
        message(FATAL_ERROR "Protobuf_SRC_ROOT_FOLDER must be set to the protobuf source directory")
    endif()

    set(PROTOC_BUILD_DIR "${PROTO_BUILD_PATH}/build-protoc-${PROTOBUF_DIR_SUFFIX}")
