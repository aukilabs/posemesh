...
set(NETWORKING_PKG_PREFIX "${NETWORKING_PREFIX}/pkg/networking")
set(NETWORKING_TARGET_PREFIX "${NETWORKING_PREFIX}/target/networking")
...
function(LINK_NETWORKING_LIBRARY NAME)
    ...
    if(APPLE)
        set(NETWORKING_LIBRARY "${NETWORKING_TARGET_DIR_WITH_BUILD_TYPE}/libnetworking_static.a")
    elseif(EMSCRIPTEN)
